...
{'Topics': [{'TopicArn': 'arn:aws:sns:us-east-1:123456789012:first-topic'}, {'TopicArn': 'arn:aws:sns:us-east-1:123456789012:second-topic'}], 'ResponseMetadata': {'RequestId': '3f1478c7-33a9-11df-9540-99d0768312d3', 'HTTPStatusCode': 200, 'HTTPHeaders': {'server': 'amazon.com'}, 'RetryAttempts': 0}}
```
...
<script.py> output:
    https://gid-staging.s3.amazonaws.com/final_report.csv?AWSAccessKeyId=IAmAFakeKey&Signature=v7S8XYuRNzyqbxtq6NCRC8CYX0I%3D&Expires=1633777102
```
